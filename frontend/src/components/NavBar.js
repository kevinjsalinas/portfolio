...
function NavBar() {
    ...
    return (
        ...
        <div>
            <div 
            className={`bg-blue-600 h-screen p-5 pt-8 ${open ? "w-72" : "width:5rem"} duration-300 relative`}>
            <BsArrowLeftShort 
            ...
            <div className="inline-flex">
                <h1 className={`bg-amber-200 text-4xl rounded cursor-pointer block float-left mr-2 duration-500 ${open && "rotate-[360deg]"}`}>ks</h1>
